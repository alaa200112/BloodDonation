...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        genderTxt=(Spinner) findViewById(R.id.gender);
         bloodTypeTxt=(Spinner) findViewById(R.id.inputBloodGroup);
...
// (See MyAppGlideModule for Loader registration)
        ...
        int genderP,bloodTypeP;

        if(getIntent().getExtras().getString("bloodType").equals("A-"))
            bloodTypeP=1;
        else if(getIntent().getExtras().getString("bloodType").equals("O-"))
            bloodTypeP=2;
        else if(getIntent().getExtras().getString("bloodType").equals("O+"))
            bloodTypeP=3;
        else if(getIntent().getExtras().getString("bloodType").equals("B+"))
            bloodTypeP=4;
        else if(getIntent().getExtras().getString("bloodType").equals("B-"))
            bloodTypeP=5;
        else if(getIntent().getExtras().getString("bloodType").equals("AB-"))
            bloodTypeP=6;
        else if(getIntent().getExtras().getString("bloodType").equals("AB+"))
            bloodTypeP=7;
        else
        ...
        if(getIntent().getExtras().getString("gender").equals("Male"))
            ...
            genderP=1;
        genderTxt.setSelection(genderP);
        bloodTypeTxt.setSelection(bloodTypeP);
        genderTxt.setSelection(genderP);
        bloodTypeTxt.setSelection(bloodTypeP);
                                ...
                                db.collection("Users")
                                        ...
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                Toast.makeText(SettingsActivity.this, "DocumentSnapshot successfully written.", Toast.LENGTH_SHORT).show();
                                            }
                                        })
                                        .addOnFailureListener(new OnFailureListener() {
                                            @Override
    ...
    private void userInfoSaved()
    {
       ...
       /* else if (TextUtils.isEmpty(userEmailEditText.getText().toString()))
        ...
        else if (TextUtils.isEmpty(genderTxt.getSelectedItem().toString()))
        {
            Toast.makeText(this, "Gender is mandatory.", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(bloodTypeTxt.getSelectedItem().toString()))
        {
            Toast.makeText(this, "Blood Type is mandatory.", Toast.LENGTH_SHORT).show();
        }
    ...
    private void updateOnlyUserInfo()
    {
        ...
        if(!TextUtils.isEmpty(bloodTypeTxt.toString())) {
            userMap. put("bloodType", bloodTypeTxt.getSelectedItem().toString());
        }
        if(!TextUtils.isEmpty(genderTxt.toString())) {
            userMap. put("gender", genderTxt.getSelectedItem().toString());
        }
