...
public class requestModel {
    ...
    public requestModel( String text, String date, String creator_email, String title, String reciver_email, String approved)
    {
    ...
    public void saveData( String text, String date, String creator_email, String title, String reciver_email, String approved){
        ...
        fp.collection("requests")
                .document(FirebaseAuth.getInstance().getUid()+"_"+x)
                .set(new requestModel(text,date,creator_email,title,reciver_email,approved));
        x++;
    }
